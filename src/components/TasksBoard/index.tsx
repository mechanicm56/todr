...
// // Defining the expected props for TasksBoard
...
// // Component to display a list of tasks or an empty state
// export function TasksBoard({ tasks, ...props }: TasksBoardProps) {
//   // Filtering the completed tasks from the task list
...
//       {/* Header displaying created and completed task counts */}
//       <header>
...
//             {tasks.length ? <span>of {tasks.length}</span> : ''}
//           </span>
//         </p>
//       </header>

//       {/* If there are tasks, display them; otherwise show EmptyTasks component */}
//       {tasks.length ? (
